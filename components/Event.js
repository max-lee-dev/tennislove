...
function Event({
  ...
  return (
    <View style={styles.eventContainer}>
      ...
      <View style={{backgroundColor: 'transparent', height: "50%", padding: 0}}>
        {location === "South High School" &&
          <Image source={loc1} style={{width: '95%', opacity: 0.5, height: '100%', resizeMode: 'cover'}}/>
        }
        {location === "Allenwood" &&
          <Image source={loc2} style={{width: '95%', opacity: 0.5, height: '100%', resizeMode: 'cover'}}/>
        }
      ...
      <View style={styles.HStack}>
        <View style={{
          ...
          <View>
            <Text style={styles.infoTextPadding}>when</Text>
            <View style={styles.HStack}>
        ...
        <TouchableOpacity disabled={creatorUID === auth.currentUser.uid} onPress={() => sendRequest()}
          ...
          <Icon name={'send'} size={25} color={creatorUID === auth.currentUser.uid ? "gray" : "#fe6446"}/>
        </TouchableOpacity>
      </View>
